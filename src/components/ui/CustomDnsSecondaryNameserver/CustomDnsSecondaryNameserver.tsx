    ...
    return (
      <Stack as="section" gap="l2" horizontal={isMinLargeScreen} {...props}>
        ...
        <Stack gap="m" grow={1} className={columnClassName}>
          ...
          <Text>
            If you choose to use a secondary nameserver, you must find a
            secondary nameserver service provider. Your domain name registrar or
            virtual cloud provider may provide this service for you. Once you
            set up the secondary nameserver service, enter the hostname (not the
            IP address) of their secondary nameserver in field.
          </Text>
        </Stack>
        <Stack
          gap="m"
        ...
        >
          ...
          <MessageBar>
            To enable zone transfers to additional servers without listing them
            as secondary nameservers, add an IP address or subnet using
